...
output AZURE_AI_ACCOUNT_RESOURCE_ID string = '/subscriptions/${subscription().subscriptionId}/resourceGroups/${resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/${aiProject.outputs.aiServicesAccountName}'
output AZURE_AI_PROJECT_RESOURCE_ID string = aiProject.outputs.projectId
